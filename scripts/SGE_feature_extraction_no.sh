...
study_root="/datagrid/Medical/microscopy/CAMELYON16/patches/patches_meta_normal"
...
input_file="${study_root}/Normal_${id}_l${lev}_s${sz}.csv"

file_suffix="_l${lev}_s${sz}_pext_${pext}_bgcorr_mswav_stru_hist_txt_features.csv"
output_file="$EXEC_ROOT/${output_dir}/cam16_normal_${id}_${file_suffix}"
log_file="$EXEC_ROOT/logfiles/normal_${id}_rtime.log"
