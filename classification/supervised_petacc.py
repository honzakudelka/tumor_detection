...
if __name__ == "__main__":
    ...
    algorithms = [#(LinearSVC(), lin_svm_params, "Linear SVM"),
                  (RandomForestClassifier(class_weight="balanced", n_jobs=6), rf_params, "RandomForest"),
    ...
    split = int(0.2 * len(input_csv_files))
    train_csv_files = input_csv_files[:-split]
    test_csv_files = input_csv_files[-split:]

    print("Test/Validation set lengths \n {}  +  {}".format(len(input_csv_files)-split, split))
